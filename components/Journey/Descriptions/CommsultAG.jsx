    ...
    return (
        <ul className="ml-4 text-left list-disc list-inside">
            ...
            <li>
                ...
                <span className="inline-block pl-5">Addressed client-reported issues via JIRA, including developing new features, fixing bugs, and creating JUnit tests to ensure robust functionality.</span>
            </li>
            <li>
            ...
            <li>
                ...
                <span className="inline-block pl-5">Collaborated with colleagues in the Potsdam office while working remotely, ensuring effective communication and teamwork.</span>
            </li>
        </ul >
    );
};

export default CommsultAG;
