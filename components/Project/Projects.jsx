...
const data = [
  ...
  },
  {
    ...
    description: "Developed a Gmail extension using LLMs to generate AI-powered email replies based on tone and context. Built with Java, Spring Boot, and JavaScript."
  },
  {
    link: "https://youtu.be/hTWp-oHn_D4",
    categories: ["Python", "Streamlit", "Flask", "NLP", "LLMs"],
  ...
  },
  {
    ...
    categories: ["Python", "Streamlit", "NLP", "LLMs", "Visualisation", "Analysis"],
